...
export const suzeItemData: Product[] = [
  ...
  },
  {
    ...
    includes: ["margareta", "gerber", "gipsofila"],
    imageBig:
  ...
  },
  {
    ...
    price: "3.500",
    priceRange: "3.000 - 4.000",
    includes: ["ljiljan", "gerber", "gipsofila"],
  ...
  },
  {
    ...
    includes: ["ljiljan orijental", "gerber", "mrežica", "robelini"],
    imageBig:
  ...
  },
  {
    ...
    includes: ["ruža", "gladiola", "gipsofila", "robelini"],
    ...
    imageSmall:
      "/images/suze/crvena-ruza-bela-gladiola-prirodna-suza-small.jpg",
    imageSmallWebP:
      "/images/suze/crvena-ruza-bela-gladiola-prirodna-suza-small.webp",
    imageGMB: "/images/suze/crvena-ruza-bela-gladiola-prirodna-suza-gmb.jpg",
    imageMini: "/images/suze/crvena-ruza-bela-gladiola-prirodna-suza-mini.jpg",
    imageMiniWebP:
  ...
  },
  {
    ...
    price: "3.400",
    priceRange: "3.000 - 5.500",
    includes: ["margareta", "gladiola", "mrežica"],
    imageBig:
  ...
  },
  {
    ...
    price: "3.200",
    priceRange: "3.000 - 4.500",
    includes: ["margareta", "gerber", "mrežica"],
    imageBig:
  ...
  },
  {
    ...
    test: [4, 2, 9],
    id: 13,
    title: "Beli ljiljan orijental ~ Bela ruža - prirodna suza",
    price: "8.000",
    priceRange: "7.000 - 9.500",
    includes: ["ljiljan orijental", "ruža", "gipsofila", "robelini"],
    ...
    link: `/single/suza/beli-ljiljan-orijental-bele-ruze-prirodna-suza${categorySuze}`,
    sluglink: "beli-ljiljan-orijental-bele-ruze-prirodna-suza",
    availability: "https://schema.org/PreOrder",
    prodId: "SU-013",
    category: categorySchema,
  },
