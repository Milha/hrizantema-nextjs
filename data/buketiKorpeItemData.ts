...
export const buketiKorpeItemData = [
  {
    ...
    text: "Buket od 50 crvenih ruža sa perlicama, od prirodnog cveća i najkvalitetnijeg zelenila. Hrizantema cvećara Orlovača. ",
    httpaddress:
  ...
  },
  {
    ...
    includes: ["gerbere", "lovor", "robelini"],
...

  {
    ...
    text: "Crveni ljiljani simbolizuju strast, bezuslovnu ljubav, plodnost, majčinstvo, sreću i večnu ljubav. Ljiljani sugerišu da se duša pokojnika vratila u mirno stanje nevinosti. Bela ruža se kod saučešća koristi da označi nevinost i mladost. Oni takođe mogu označiti poštovanje prema osobi koja je preminula.",
    httpaddress:
...

  {
    ...
    httpaddress: `https://hrizantema.rs/single/buket-korpa/roze-ljiljan-prirodna-korpa${categoryKorpe}`,
  ...
  },
  {
    ...
    httpaddress: `https://hrizantema.rs/single/buket-korpa/crvene-bele-margarete-srce-prirodni-buket${categoryBuketi}`,
    link: `/single/buket-korpa/crvene-bele-margarete-srce-prirodni-buket${categoryBuketi}`,
