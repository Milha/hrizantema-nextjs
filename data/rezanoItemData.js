...
export const rezanoItemData = [
...

  {
    ...
    imageBigWebP:
      "/images/rezano-cvece/roze-carski-ljiljan-orijental-rezani-komadni-cvet.webp",
    imageSmall:
      "/images/rezano-cvece/roze-carski-ljiljan-orijental-rezani-komadni-cvet-small.jpg",
    imageSmallWebP:
      "/images/rezano-cvece/roze-carski-ljiljan-orijental-rezani-komadni-cvet-small.webp",
    imageGMB:
      "/images/rezano-cvece/roze-carski-ljiljan-orijental-rezani-komadni-cvet-gmb.jpg",
    imageMini:
      "/images/rezano-cvece/roze-carski-ljiljan-orijental-rezani-komadni-cvet-mini.jpg",
    imageMiniWebP:
      "/images/rezano-cvece/roze-carski-ljiljan-orijental-rezani-komadni-cvet-mini.webp",
    alt: "roze ljubicasti carski ljiljan orijental ljiljan prirodni rezani komadni cvet",
    text: "Hrizantema cvećara Orlovača. Ljubičasti carski ljiljan orijental, prirodno cveće, veliki izbor, uvek sveže.",
    httpaddress:
...

  {
    ...
    imageBigWebP:
      "/images/rezano-cvece/narandzasti-ljiljan-orijental-carski-ljiljan-rezan-komadni-cvet.webp",
    imageSmall:
      "/images/rezano-cvece/narandzasti-ljiljan-orijental-carski-ljiljan-rezan-komadni-cvet-small.jpg",
    imageSmallWebP:
      "/images/rezano-cvece/narandzasti-ljiljan-orijental-carski-ljiljan-rezan-komadni-cvet-small.webp",
    imageGMB:
      "/images/rezano-cvece/narandzasti-ljiljan-orijental-carski-ljiljan-rezan-komadni-cvet-gmb.jpg",
    imageMini:
      "/images/rezano-cvece/narandzasti-ljiljan-orijental-carski-ljiljan-rezan-komadni-cvet-mini.jpg",
    imageMiniWebP:
      "/images/rezano-cvece/narandzasti-ljiljan-orijental-carski-ljiljan-rezan-komadni-cvet-mini.webp",
    alt: "narandzasti carski ljiljan orijental ljiljan prirodni rezani komadni cvet",
    text: "Hrizantema cvećara Orlovača. Narandžasti carski ljiljan orijental, prirodno cveće, veliki izbor, uvek sveže.",
    httpaddress:
  ...
  },
  {
    ...
    test: [1, 2, 3],
    id: 21,
    title: "Hrizantema - Palisad žuta",
    price: "200",
    priceRange: "100 - 300",
    includes: null,
    imageBig:
      "/images/rezano-cvece/hrizantema-palisad-zuti-rezano-komadno-cvece.jpg",
    imageBigWebP:
      "/images/rezano-cvece/hrizantema-palisad-zuti-rezano-komadno-cvece.webp",
    imageSmall:
      "/images/rezano-cvece/hrizantema-palisad-zuti-rezano-komadno-cvece-small.jpg",
    imageSmallWebP:
      "/images/rezano-cvece/hrizantema-palisad-zuti-rezano-komadno-cvece-small.webp",
    imageGMB:
      "/images/rezano-cvece/hrizantema-palisad-zuti-rezano-komadno-cvece-gmb.jpg",
    imageMini:
      "/images/rezano-cvece/hrizantema-palisad-zuti-rezano-komadno-cvece-mini.jpg",
    imageMiniWebP:
      "/images/rezano-cvece/hrizantema-palisad-zuti-rezano-komadno-cvece-mini.webp",
    alt: "Hrizantema palisad palisada prirodni rezani komadni cvet",
    text: "Žute hrizantem simbolizuju sreću, radost i slavlje. Takodje, žute hrizanteme simbolizuju neuzvraćenu ljubav ili tugu. Hrizanteme predstavljaju i simbol istine.",
    httpaddress: `https://hrizantema.rs/single/rezano/hrizantema-palisad-zuti-rezano-komadno-cvece${categoryRezano}`,
    link: `/single/rezano/hrizantema-palisad-zuti-rezano-komadno-cvece${categoryRezano}`,
    sluglink: "hrizantema-palisad-zuti-rezano-komadno-cvece",
    availability: "https://schema.org/InStock",
    prodId: "KO-021",
    category: categorySchema,
  },
