...
export const suzeDvostranicneData = [
  ...
  },
  {
    ...
    test: [0, 0, 0],
    id: 12,
    title: "Bele ruže ~ dvostranična suza",
    price: "8.500",
    priceRange: "8.000 - 11.500",
    ...
    link: `/single/suza-dvostranicna/bela-ruza-bela-gipsofila-prirodna-dvostranicna-suza${categorySuze}`,
    sluglink: "bela-ruza-bela-gipsofila-prirodna-dvostranicna-suza",
    availability: "https://schema.org/PreOrder",
    prodId: "DS-012",
    category: categorySchema,
  },
  {
    ...
    link: `/single/suza-dvostranicna/crvena-ruza-bela-gipsofila-dvostranicna-prirodna-suza${categorySuze}`,
    sluglink: "crvena-ruza-bela-gipsofila-dvostranicna-prirodna-suza",
    availability: "https://schema.org/PreOrder",
    prodId: "DS-013",
    category: categorySchema,
  },
  {
    similarTo: [
      "Beli ljiljan ~ crveni gerber ~ bele hrizanteme",
      "Beli ljiljan ~ crvene ruže",
      "Bela kala ~ bela margareta",
    ],
    test: [0, 0, 0],
    ...
    link: `/single/suza-dvostranicna/roze-orijental-ljiljan-bela-kala-prirodna-dvostranicna-suza${categorySuze}`,
    sluglink: "roze-orijental-ljiljan-bela-kala-prirodna-dvostranicna-suza",
    availability: "https://schema.org/PreOrder",
    prodId: "DS-014",
    category: categorySchema,
  },
  {
    ...
    test: [0, 0, 0],
    id: 15,
    title: "Carski ljiljan roze ~ Bela ruža ~ Beli gerber - dvostaranična suza",
    price: "14.000",
