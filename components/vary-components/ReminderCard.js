...
const ReminderCard = () => {
  ...
  let reccenica =
    month >= 3 && month <= 9
      ? "Kapija na groblju Orlovača je otvorena od 07.00 do 19.00 - letnji period od 01.04 do 30.09 "
      : "Kapija na groblju Orlovača je otvorena od 07.00 do 18.00 - zimski period od 01.10 do 31.03";
  ...
  return (
    <div className={classes.cont}>
      <p className={classes.text}>
        ...
        grobljima: 14.02.2026 Velike - zimske zadušnice
      </p>
      <hr></hr>
