      ...
      <div className={classes.contact_cont}>
        ...
        <div className={classes.contact_item}>
          <p className={classes.contact_about_us}>
            Cvećara otvorena još davne 1994 u tržnom centru pored glavnog ulaza
            i neposrednoj blizini crkve. Bavimo se izradom svih vrsta prirodnih
            i veštačkih cvetnih aranžmana, venaca, suza, ikebana, korpi. Svi
            aranžmani mogu biti izradjeni prema vašoj želji, kombinacijom cveća
            po vašem izboru.
          </p>
        </div>
      </div>
